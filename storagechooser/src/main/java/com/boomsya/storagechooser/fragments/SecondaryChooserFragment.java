package com.boomsya.storagechooser.fragments;
...
import com.boomsya.storagechooser.R;
import com.boomsya.storagechooser.StorageChooser;
import com.boomsya.storagechooser.StorageChooserView;
import com.boomsya.storagechooser.adapters.SecondaryChooserAdapter;
import com.boomsya.storagechooser.models.Config;
import com.boomsya.storagechooser.utils.DiskUtil;
import com.boomsya.storagechooser.utils.FileUtil;
import com.boomsya.storagechooser.utils.ResourceUtil;
...
//        mNewFolderButton.setImageDrawable(ContextCompat.getDrawable(mContext, R.drawable.plus));
	...
	private View getLayout(LayoutInflater inflater, ViewGroup container) {
		...
		initListView(mContext, mLayout, mConfig.isShowMemoryBar(), mConfig.isShowFreeSpace());
	...
	private void updateUI() {
		...
		//mSelectButton.setText(StorageChooserView.LABEL_SELECT); //kolio
		//mCreateButton.setText(StorageChooserView.LABEL_CREATE);

		if (mConfig.getCreateLabelText() != null) {//kolio
			mSelectButton.setText(mConfig.getCreateLabelText());
		} else {
			mSelectButton.setText(getString(R.string.label_select));
		}

		mCreateButton.setText(getString(R.string.label_create));

		mSelectButton.setTextColor(mResourceUtil.getColor(R.color.colorPrimary));
	 ...
	 */
	private void initListView(Context context, View view, boolean shouldShowMemoryBar, boolean showFreeSpace) {
		...
		secondaryChooserAdapter = new SecondaryChooserAdapter(customStoragesList, context, shouldShowMemoryBar, showFreeSpace);
