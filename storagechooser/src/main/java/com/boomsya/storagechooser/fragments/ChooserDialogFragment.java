...
import com.boomsya.storagechooser.adapters.StorageChooserListAdapter;
...
public class ChooserDialogFragment extends DialogFragment {
	...
	private View getLayout(LayoutInflater inflater, ViewGroup container) {
		...
		initListView(getContext(), mLayout, mConfig.isShowMemoryBar(), mConfig.isShowFreeSpace());
	...
	private void initListView(Context context, View view, boolean shouldShowMemoryBar, boolean showFreeSpace) {
		...
		if (mConfig.isSkipOverview()) {
			...
			listView.setAdapter(new StorageChooserListAdapter(storagesList, context, shouldShowMemoryBar, showFreeSpace));
		}
