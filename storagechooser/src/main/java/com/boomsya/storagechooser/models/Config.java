package com.boomsya.storagechooser.models;
...
public class Config {
    ...
    public boolean isShowFreeSpace() {
        return showFreeSpace;
    }

    public void setShowFreeSpace(boolean showFreeSpace) {
        this.showFreeSpace = showFreeSpace;
    }

    public void setCreateLabelText(String createLabelText) {
        this.createLabelText = createLabelText;
    }

    public String getCreateLabelText() {
