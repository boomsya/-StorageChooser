...
import com.boomsya.storagechooser.utils.ThumbnailUtil;
...
public class SecondaryChooserAdapter extends BaseAdapter {
    ...
    public SecondaryChooserAdapter(List<String> storagesList, Context mContext, boolean shouldShowMemoryBar, boolean showFreeSpace) {
    ...
    private void applyFolderTint(ImageView im) {
        ...
        im.setImageDrawable(ContextCompat.getDrawable(mContext, R.drawable.ic_folder_icon));
    }
